...
class CodexAgentAdapter : AgentAdapter {
    ...
    override fun resume(request: AgentResumeRequest): AgentResumeResult {
        ...
        if (!dispatched) {
            return AgentResumeResult(AgentResumeStatus.FAILED, durationMs, "DISPATCH_FAILED", "Failed to send Codex resume command")
        }
    ...
    private fun buildResumeCommand(sessionReference: String): String {
        ...
        return "codex resume ${escapeArgument(sessionReference)}"
    }
